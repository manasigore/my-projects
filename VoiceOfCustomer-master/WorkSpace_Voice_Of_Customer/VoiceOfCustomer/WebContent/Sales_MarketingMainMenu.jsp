...
<title>SALES AND MARKETING MAIN MENU</title>
...
BUSINESS PHONE FEEDBACK REPORT  &nbsp;<input type="button" name="b1" value="VIEW PDF" name="BUSINESS PHONE REPORT" onClick="Business()"> <br><br><br>
GAMING PHONE FEEDBACK REPORT &nbsp;<input type="button" name="b1" value="VIEW PDF" name="GAMING PHONE REPORT" onClick="Gaming()"> <br><br><br>
STANDARD PHONE FEEDBACK REPORT &nbsp;<input type="button" name="b1" value="VIEW PDF" name="STANDARD PHONE REPORT" onClick="Standard()"><br><br><br>
SERVICE FEEDBACK REPORT &nbsp;<input type="button" name="b1" value="VIEW PDF" name="SERVICE PHONE REPORT" onClick="Service()"><br><br><br>
SURVEY  FEEDBACK REPORT &nbsp;<input type="button" name="b1" value="VIEW PDF" name="SURVEY  REPORT" onClick="Survey()"><br><br><br>
