...
<fieldset>
		<legend><font size="4" color="#2E9AFE"><i>STANDARD PHONE FEEDBACK FORM :&nbsp; </i></font> </legend>



<body background="Images/feedback.jpg" width="200" height="228" >
<form name="standardfeedbackform" action="/VoiceOfCustomer/ReceivedFeedbackForm" method="POST">
