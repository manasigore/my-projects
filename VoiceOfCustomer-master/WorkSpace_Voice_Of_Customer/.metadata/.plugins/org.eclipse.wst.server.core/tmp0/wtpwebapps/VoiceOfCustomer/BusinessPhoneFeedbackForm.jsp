...
int listsize = 0;
  ...
  try
  {
    li =  (ArrayList<String>)request.getAttribute("questions");
...
<fieldset>
		<legend><font size="4" color="#2E9AFE"><i>BUSINESS PHONE FEEDBACK FORM :&nbsp; </i></font> </legend>



<body background="Images/feedback.jpg" width="200" height="228" >

<form name="businessfeedbackform" action="/VoiceOfCustomer/ReceivedFeedbackForm" method="POST">
